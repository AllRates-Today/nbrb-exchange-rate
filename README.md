# National Bank of the Republic of Belarus Exchange Rate API — nbrb-exchange-rate
...
Also published under the org scope as [`@allratestoday/nbrb-exchange-rate`](https://www.npmjs.com/package/@allratestoday/nbrb-exchange-rate) — same code, same versions.
...
```javascript
{
  ...
  rate_date: '2026-08-21',   // National Bank of the Republic of Belarus's own publication date
  source: 'USD',
  target: 'BYN',
  rate: 2.9829,
  rate_type: 'reference',
...
```javascript
{
  ...
  rates: [
    { "base": "USD", "quote": "BYN", "type": "reference", "value": 2.9829 },
...
const series = await getHistory(
  { source: 'USD', target: 'BYN', from: '2026-01-01', to: '2026-08-21' },
  { apiKey: 'art_live_...' }
);
```
...
```javascript
{
  ...
  rates: [
    ...
    { date: '2026-08-21', rate: 2.9829, rate_type: 'reference', derived: false, method: 'published' },
    // …
  ],
  disclaimer: '…'
}
