// National Bank of the Republic of Belarus exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/nbrb';
...
/** Latest rate for one pair, e.g. getRate('USD', 'BYN', { apiKey }). */
